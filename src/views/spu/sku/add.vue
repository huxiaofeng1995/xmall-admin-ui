<template>
  <el-card class="form-container" shadow="never" style="width: 1200px">
    ...
    <div style="margin-top: 50px">
      <el-form ref="spuForm" label-width="120px" style="width: 1100px" size="small">
        ...
        <el-form-item label="商品规格：">
          ...
          <el-table style="width: 100%;margin-top: 20px"
                    :data="skuStockList"
                    border>
            <el-table-column label="颜色"  align="center" v-if="showColor">
              <template slot-scope="scope">
                {{scope.row.shp_ys.split("-")[1]}}
              </template>
            </el-table-column>
            <el-table-column label="版本" align="center" v-if="showVersion">
              <template slot-scope="scope">
...
<script>
  ...
  import {addColor,addVersion,delColor,delVersion} from "@/api/attr";
